...
<body style="padding-right:20px; padding-bottom:20px">
	<div align="left">
		<h3 class="style1">IPv6 Addresses: Bulk Create</h3>
	</div>
	...
	<div>
		...
		?>
		<form action="<?php echo base_url('main/processBulkIpV6AddressCreation'); ?>" method="POST" enctype="multipart/form-data">
			<table>
				<tr>
		...
		?>
		<form action="<?php echo base_url('main/processBulkIpV6AddressCreation'); ?>" method="POST">
