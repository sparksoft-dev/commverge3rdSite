...
<body style="padding-right:20px; padding-bottom:20px;">
    <div>
        <h3 class="style1">Realms: Create</h3>
    </div>
    ...
    <div>
        <FORM name="frmMain" action="<?php echo base_url('main/processRealmCreation'); ?>" method="post">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="smallFontWHTBG" align="left">
                            <input type="text" name="realm" value="<?php echo isset($realm) && !is_null($realm) ? $realm : ''; ?>" />
                        </td>
                    </tr>
                    <tr>
