...
<body style="padding-right:20px; padding-bottom:20px;">
	...
	<div align="center">
		<form name="frmMain" action="<?php echo base_url('main/showOnlineSessionDo'); ?>" method="POST">
		...
		<!-- Added false to remove Service Plan table 5/21/19 -->
		<!-- false && -->
		<?php 
				if (false && isset($usage) && !is_null($usage['responseCode']) && intval($usage['responseCode']) == 200) {
		?>
		<?php
