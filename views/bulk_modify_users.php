...
<body style="padding-right:20px; padding-bottom:20px;">
	<div align="left">
		<h3 class="style1">Primary Account: Bulk Modify</h3>
	</div>
	<div align="right">
	...
	<div>
		...
		?>
		<form id="bulkUploadForm" action="<?php echo base_url('subscribers/processBulkUpdateSubscribers'); ?>" method="POST" ENCTYPE="multipart/form-data">
			<table>
				<tr>
		...
		?>
		<form id="bulkConfirmForm" action="<?php echo base_url('subscribers/processBulkUpdateSubscribers'); ?>" method="POST">
			...
			<input type="hidden" name="selectedstatus" value="<?php echo $status; ?>">
		...
		?>
		<form action="<?php echo base_url('subscribers/processBulkUpdateSubscribers'); ?>" method="POST">
