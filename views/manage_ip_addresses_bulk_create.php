...
<body style="padding-right:20px; padding-bottom:20px">
	<div align="left">
		<h3 class="style1">IP Addresses: Bulk Create</h3>
	</div>
	...
	<div>
		...
		?>
		<form action="<?php echo base_url('main/processBulkIpaddressCreation'); ?>" method="POST" enctype="multipart/form-data">
			<table>
				<tr>
		...
		?>
		<form action="<?php echo base_url('main/processBulkIpaddressCreation'); ?>" method="POST">
		...
		<table cellspacing="1" cellpadding='3' style="background-color:#cccccc;" border="0" width="100%">
			<tbody>
				<tr>
					...
					<td class="smallFontGRYBG" align="left" nowrap>Is GPON</td>
		...
		?>
		<br /><br /><br />
		<span class="errorMsg">The following records were not created because of an invalid IP address.</span>
		<table cellspacing="1" cellpadding="3" style="background-color:#cccccc;" border="0" width="100%">
			<tbody>
				<tr>
					<td class="smallFontGRYBG" align="left" nowrap>&nbsp;</td>
		...
		<?php
				...
				if (count($existingIP) != 0) {
		?>
		<br /><br /><br />
		<span class="errorMsg">The following records were not created because the IP addresses already exist.</span>
		<table cellspacing="1" cellpadding="3" style="background-color:#cccccc;" border="0" width="100%">
			<tbody>
				<tr>
					<td class="smallFontGRYBG" align="left" nowrap>&nbsp;</td>
