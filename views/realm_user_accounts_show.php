...
<body style="padding-right:20px; padding-bottom:20px;">
	<div>
		<h3 class="style1">Realm User Account</h3>
	</div>
	<div align="center">
			...
			<tbody>
				<tr>
					<td class="regular" align="center">
						<strong><span style="text-decoration:underline;"><?php echo $realm; ?></span></strong> User Account
					</td>
				</tr>
			</tbody>
		</table>
							...
							<tbody>
								...
								<tr>
									...
									<td class="myFontWHT" width="70%">
										<strong><?php echo !is_null($subscriber['CUSTOMERTYPE']) ? ($subscriber['CUSTOMERTYPE'] == 'M' ? 'Post Paid (M)' : 'Prepaid Login Base (L)') : ''; ?></strong>
									</td>
								</tr>
								<tr>
